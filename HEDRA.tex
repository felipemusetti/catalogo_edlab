...
\vspace*{-3.4cm}
\hspace*{-2.1cm}\includegraphics*[width=160mm]{./imgs/HEDRA.png}
\end{textblock*}
...
\begin{center}
\hspace*{-2.5cm}\raisebox{6.8cm}{\rotatebox[origin=t]{90}{\huge\Formular{\textbf{Lançamento}}}}
\hspace*{2.5cm}\includegraphics[width=92mm]{./grid/soma.png}
\end{center}
...
\begin{center}
\hspace*{.5cm}\includegraphics[width=92mm]{./grid/black.png}
\end{center}
