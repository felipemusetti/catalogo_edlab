...
\vspace*{-3.5cm}
\hspace*{-2.77cm}\includegraphics*[width=175.2mm]{./propagandas/KALINKA.pdf}
\end{textblock*}
...
uma criança por um amigo.\footnote{Adaptado do prefácio do livro {\slsc{A Cidade Ene}}. Tradução de Moissei Mountian.} 
