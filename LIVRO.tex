...
\fancyhead[L]{\hspace{1.1cm} \thepage \hspace{.25cm} {\Formular{\textbf{Livros}}}}
\fancyfoot[C]{}
}

\fancypagestyle{indice}{
\fancyhf{}
\fancyhead[L]{\hspace{1.1cm} {\Formular{\textbf{Catálogo 2020/ 1}}}}
\fancyfoot[C]{}
}
...
\fancyhf{}
\fancyhead[R]{Catálogo Edlab \hspace{1cm}}
\fancyhead[L]{\hspace{1.1cm} \thepage \hspace{.25cm} {\Formular{\textbf{Aylllon}}}}
\fancyfoot[C]{}
}
...
\fancyhf{}
\fancyhead[R]{Catálogo Edlab \hspace{1cm}}
\fancyhead[L]{\hspace{1.1cm} \thepage \hspace{.25cm} {\Formular{\textbf{Azougue}}}}
\fancyfoot[C]{}
}
...
\fancyhf{}
\fancyhead[R]{Catálogo Edlab \hspace{1cm}}
\fancyhead[L]{\hspace{1.1cm} \thepage \hspace{.25cm} {\Formular{\textbf{Circuito}}}}
\fancyfoot[C]{}
}
...
\fancyhf{}
\fancyhead[R]{Catálogo Edlab \hspace{1cm}}
\fancyhead[L]{\hspace{1.1cm} \thepage \hspace{.25cm} {\Formular{\textbf{hedra}}}}
\fancyfoot[C]{}
}
...
\fancyhf{}
\fancyhead[R]{Catálogo Edlab \hspace{1cm}}
\fancyhead[L]{\hspace{1.1cm} \thepage \hspace{.25cm} {\Formular{\textbf{Imã}}}}
\fancyfoot[C]{}
}
...
\fancyhf{}
\fancyhead[R]{Catálogo Edlab \hspace{1cm}}
\fancyhead[L]{\hspace{1.1cm} \thepage \hspace{.25cm} {\Formular{\textbf{Kalinka}}}}
\fancyfoot[C]{}
}
...
\fancyhf{}
\fancyhead[R]{Catálogo Edlab \hspace{1cm}}
\fancyhead[L]{\hspace{1.1cm} \thepage \hspace{.25cm} {\Formular{\textbf{n-1 edições}}}}
\fancyfoot[C]{}
}
...
\fancyhf{}
\fancyhead[R]{Catálogo Edlab \hspace{1cm}}
\fancyhead[L]{\hspace{1.1cm} \thepage \hspace{.25cm} {\Formular{\textbf{$\square\bigcirc$}}}}
\fancyfoot[C]{}
}
%--------------------------------------------
