...
\noindent{}{\slsc{Riot days}} é um relato cru, alucinatório e apaixonado \hlc[lightyellow]{escrito por Maria Alyokhina, da banda punk feminista russa Pussy Riot, sobre sua prisão e julgamento em uma colônia penal nos Urais após participar de um protesto punk contra Putin em uma igreja ortodoxa.}

O livro vem embalado em uma balaclava colorida, símbolo universal de resistência e luta social, confeccionada especialmente pela Cooperativa Libertas, de mulheres egressas da máquina do sistema penitenciário brasileiro. Vem também acompanhado de dois cordéis --- {\slsc{Sobre (Viver)}} e {\slsc{Engaiolaram"-nos}}. A soma das obras produz uma síntese que aponta para características partilhadas entre as mulheres de todo o mundo: entre a banda Pussy Riot, perseguida em uma Rússia onde direitos das minorias são tolhidos, e as brasileiras que sofrem em um sistema desumano, há muito em comum. 
...
Título: Nós somos Pussy Riot [combo]\\
...
\hspace*{3.1cm}\includegraphics[width=74mm]{./grid/butler.png}
\end{center}
...
{\small\fakereceipt{
\noindent{}“O objeto conecta pessoas de modos invisíveis, às
...
{\small\fakereceipt{
\noindent{}“Se perguntamos sobre a
...
{\slsc{lockdown}}, em nome da igualdade do vivente.

\noindent{}\textcolor{gray}{\footnotesize\slsc{Texto originalmente publicado no site da n-1 edições. Tradução de André Arias e Clara Barzaghi.}}
...
\begin{center}
\hspace*{-3.6cm}\raisebox{5cm}{\rotatebox[origin=t]{90}{\huge\Formular{\textbf{Lançamento}}}}
\hspace*{3.1cm}\includegraphics[width=74mm]{./grid/deligny.jpg}
\end{center}
...
\item Agamben: por uma ética da vergonha e do resto, {\Formular{\textbf{Oswaldo Giacóia Junior}}}
...
\item Necropolítica, {\Formular{\textbf{Achille Mbembe}}}
\item Esferas da inssureição: notas para uma vida não cafetinada, {\Formular{\textbf{Suely Rolnik}}}
}}
}
\end{enumerate}
\end{multicols}
