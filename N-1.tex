...
\noindent{}\hlc[lightyellow]{``Riot days'' é um relato cru, alucinatório e apaixonado sobre a prisão e julgamento de Maria Alyokhina em uma colônia penal nos Urais após participar junto com Pussy Riot, sua banda punk feminista, de um protesto punk contra Putin em uma igreja ortodoxa.}

Embalado em uma balaclava colorida, símbolo universal de resistência e luta social, confeccionadas especialmente pela Cooperativa Libertas, de mulheres egressas da máquina do sistema penitenciário brasileiro, o livro vem acompanhado de dois cordéis --- {\slsc{Sobre (Viver)}} e {\slsc{Engaiolaram"-nos}}. Entre a banda Pussy Riot, perseguida em uma Rússia onde direitos das minorias são tolhidos, e as brasileiras que sofrem em um sistema desumano, há muito em comum. 
...
\textcolor{gray}{\footnotesize\slsc{Texto originalmente publicado no site da n-1 edições. Tradução de André Arias e Clara Barzaghi.}}
